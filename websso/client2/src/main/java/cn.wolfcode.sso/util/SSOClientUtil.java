...
public class SSOClientUtil {
    ...
    public static String SERVER_URL_PREFIX;//统一认证中心地址:http://www.sso.com:8080,在sso.properties配置
    public static String CLIENT_HOST_URL;//当前客户端地址:http://www.client2.com:8002,在sso.properties配置
    static{
        try {
